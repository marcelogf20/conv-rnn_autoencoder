...
def cyclic_learning_rate(global_step,
                         ...
                         mode='triangular',
                         name=None):
    new_lr = cyclic_lr(global_step, learning_rate, max_lr, step_size, gamma,
                       mode, name)
...
def cyclic_lr(global_step, learning_rate, max_lr, step_size, gamma, mode, name):
    if global_step is None:
        raise ValueError("global_step is required for cyclic_learning_rate.")
    if mode not in ["triangular", "triangular2", "exp_range"]:
        raise ValueError("invalid mode for cyclic_learning_rate.")

    def update_lr(global_step, learning_rate, max_lr, step_size, gamma, mode,
               name):
        with ops.name_scope(name, "CyclicLearningRate",
                            [global_step, learning_rate, step_size]) as name:
    ...
    return partial(update_lr, global_step, learning_rate, max_lr, step_size,
                   gamma, mode, name)
